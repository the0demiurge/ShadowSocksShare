...
import getopt
import logging
from ssshare.shadowsocks.common import to_bytes, to_str, IPNetwork, PortRange
from ssshare.shadowsocks import encrypt
...
def __version():
    ...
    try:
        ...
        try:
            from ssshare.shadowsocks import version
