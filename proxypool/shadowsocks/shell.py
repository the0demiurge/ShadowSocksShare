...
import getopt
import logging
from proxypool.shadowsocks.common import to_bytes, to_str, IPNetwork, PortRange
from proxypool.shadowsocks import encrypt
...
def __version():
    ...
    try:
        ...
        try:
            from proxypool.shadowsocks import version
